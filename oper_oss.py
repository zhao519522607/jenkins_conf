...
def option_parser():
	try:
		parser = optparse.OptionParser("python oper_oss.py -h |For Example: python oper_oss.py -m upload || python oper_oss.py -m download -f package/fxapi/test2")
		...
		parser.add_option('-f', action='store', dest='file',
                          default='/data1/python/jenkins_list', help=(u'需要上传的文件列表文件或者需要下载的文件路径'))
		return parser
	except:
